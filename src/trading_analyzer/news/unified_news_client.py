...
class UnifiedNewsClient:
    ...
    def get_unified_news(self, ticker: str, limit_per_source: Optional[int] = None) -> Dict[str, Any]:
        """
    ...
    def get_news_by_source(self, ticker: str, source: str, limit: Optional[int] = None) -> List[Dict[str, Any]]:
        """
        ...
        if source.lower() == 'yfinance':
            ...
            raise ValueError(f"Unknown source: {source}. Available sources: yfinance, tipranks")
